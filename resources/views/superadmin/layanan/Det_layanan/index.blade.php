...
<div class="modal fade" id="exampleModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 50%">
        <div class="modal-content">
            ...
            <form action="{{ url('/superadmin/layanan/Det_layanan')}}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 50%">
        <div class="modal-content">
            ...
            <form action="{{ url('/superadmin/layanan/Det_layanan/simpan') }}" method="POST" enctype="multipart/form-data">
                @method("PUT")
                {{ csrf_field() }}
...
<script type="text/javascript">
    ...
    function editD(id) {
        $.ajax({
            url: "{{ url('/superadmin/layanan/Det_layanan/edit') }}",
            type: "GET",
            data: {
                id: id
            },
    ...
    function detailD(id) {
        $.ajax({
            url: "{{ url('/superadmin/layanan/Det_layanan/detail') }}",
            type: "GET",
            data: {
                id: id
            },
