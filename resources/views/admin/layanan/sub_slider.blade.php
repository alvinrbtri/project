...
<section class="home-section">
                         ...
                         @foreach ($subslider as $slider)
                            <tr>
                                ...
                                <td class="td" style="size: 30px;">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal8-{{ $slider->id }}" class="btndetail">
                                        <i class='bx bx-detail'></i>
                                    </button>
                                    <button class="btndelete" ><a href="javascript:" rel="{{ $slider->id }}" rel1="kategori" id="deletekategori" class="bx bx-trash" ></a></button>
    ...
    <!-- Modal Detail-->
    {{-- @foreach ($subslider as $slider)  
        <div class="modal fade" id="exampleModal8-{{ $slider->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
