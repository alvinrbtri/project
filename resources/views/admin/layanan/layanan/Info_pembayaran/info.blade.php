                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ url('/storage/' .$info->image)}}" style="width: 120px;"></td>
                            <td>{{ $info->judul }}</td>
                            <td>{!! $info->deskripsi !!}</td>
                            <td style="size: 20px;">
                                <div class="row col-md-12">
                                    <div class="col-md-8 text-end">  
                                        <button onclick="editInfo({{$info->id}})" type="button" class="btn btnedit" data-bs-toggle="modal" data-bs-target="#exampleModalEdit">
                                        <i class='bx bx-edit'></i>
                                        </button>
                                    </div>
                                    <div class="col-md-3 text-end">
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('info.destroy', $info->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
...
<div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 50%">
        <div class="modal-content">
            ...
            <form action="{{ url('/Info_pembayaran/simpan')}}" method="POST" enctype="multipart/form-data">
                @method("PUT")
                @csrf
