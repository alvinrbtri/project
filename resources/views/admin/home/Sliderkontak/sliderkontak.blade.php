        ...
        <div class="details1 ">
            <div class="recentOrders">
                ...
                <table>
                    ...
                    <tbody>
                        @foreach ($data_shome as $sliderkontak)
                        <tr>
                            ...
                            <td style="size: 20px;">
                                <div class="row col-md-12">
                                    <div class="col-md-8 text-end">  
                                        <button onclick="editSliderKontak({{$sliderkontak->id}})" type="button" class="btn btnedit" data-bs-toggle="modal" data-bs-target="#exampleModalEdit">
...
<div class="modal fade" id="exampleModalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 50%">
        <div class="modal-content">
            ...
            <form action="{{ url('/sliderkontak')}}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 50%">
        <div class="modal-content">
            ...
            <form action="{{ url('/Sliderkontak/simpan')}}" method="POST" enctype="multipart/form-data">
                @method("PUT")
                @csrf
