...
<section class="home-section">
    <div class="main">
        <div class="d-flex align-content-end flex-wrap">
            ...
            <div class="p-2">
                <div class="search text-end" data-aos="fade-left" data-aos-duration="1000">
                    <label>
            ...
            <div class="p-2">
                <div class="col-md-4 text-start pe-3" style="font-size: 30px" data-aos-duration="1000">
    ...
    {{-- Card User Profile --}}
    <div class="row g-3 mb-3" data-aos="fade-up" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000">
                ...
                <div class=" p-3">
                    <form class="row g-3 fw-bold">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control input-text" id="firstName" placeholder="first name" value="{{ Auth::user()->first_name }}">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control input-text" id="inputAddress" placeholder="address" value="{{ Auth::user()->address }}">
                        </div>
                        <div class="col-md-6">
                            <label for="inputCity" class="form-label">City</label>
                            <input type="text" class="form-control input-text" id="inputCity" placeholder="city" value="{{ Auth::user()->city }}">
                        </div>
                        <div class="col-md-4">
