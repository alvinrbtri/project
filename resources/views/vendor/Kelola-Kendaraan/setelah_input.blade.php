    ...
    <div class="main">
        ...
        <div class=" p-3">
            <div class="cardBox1">
                <div class="card2">
                    <div>
                        <a href="/Vendor/Kelola-Kendaraan/setelah_input" style="text-decoration:none">
                ...
                <div class="card1">
                    <div>
                        <a href="/Vendor/Kelola-Bangunan/setelah_input" style="text-decoration:none">
                ...
                <div class="card1">
                    <div>
                        <a href="/Vendor/Kelola_Barang/setelah_input" style="text-decoration:none">
                ...
                <div class="card1">
                    <div>
                        <a href="/Vendor/Kelola-PickUp/setelah_input" style="text-decoration:none">
            ...
            <div class="p-5 container card mb-5 " style="width: 90%">
                <a href="/Vendor/Kelola-Kendaraan/layanan_step1 "><button class="btn btn-success p-2  "
