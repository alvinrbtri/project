    ...
    <section class="home-section">
        ...
        <div class="main">
            ...
            <div class="cardBox" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="card border-0">
                    <div class="card-body">
                        <div class="" style="color:rgb(255, 185, 93); font-size:20px"><i
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Paid</td>
                                <td class="text-start"><span class="btn btn-danger col-md-12"
                                        style="font-size: 13px ">Return</span></td>
                            </tr>
                            <tr>
                                <td>iPhone 13 pro</td>
                                ...
                                <td>Paid</td>
                                <td class="text-start"><span class="btn btn-success col-md-12"
                                        style="font-size: 13px ">Delivered</span></td>
                            </tr>
                            <tr>
                                <td>Quick Traktor</td>
                                ...
                                <td>Paid</td>
                                <td class="text-start"><span class="btn btn-warning col-md-12"
                                        style="font-size: 13px ">Pending</span></td>
                            </tr>
                            <tr>
                                <td>RX King</td>
                                <td class="text-center">Bangunan</td>
                                ...
                                <td>Paid</td>
                                <td class="text-start"><span class="btn btn-info col-md-12" style="font-size: 12px">In
                                        Progress</span></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Paid</td>
                                <td class="text-start"><span class="btn btn-danger col-md-12"
                                        style="fnt-size: 13px">Delivered</span></td>
                            </tr>
                            <tr>
                                <td>Quick Traktor</td>
                                <td class="text-center">Kendaraan</td>
                            ...
                            <tr>
                                ...
                                <td class="text-start">IDR 15.975.574</td>
                                <td>Paid</td>
                                <td class="text-start"><span class="btn btn-info col-md-12" style="font-size: 13px">In
                                        Progress</span></td>
                            </tr>
                            <tr>
                                <td>Yamaha Jupiter</td>
                        ...
                        <div class="row ">
                            <div class=" col-md-12 rounded-top card mt-1 ">
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-8">
                                        <H6 data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2"
                                            aria-expanded="false" aria-controls="multiCollapseExample2">Dila__</H6>
                                        <p class="text-muted" data-bs-toggle="collapse"
                                            data-bs-target="#multiCollapseExample2" aria-expanded="false"
                                            aria-controls="multiCollapseExample2">Barang apa saja yang bisa di titipkan?
                                        </p>

                                    </div>
                                    <div class="col-md-2 text-end">
                                        <span class="float-right time text-dark">12:10</span><br>
                                        <span class="badge bg-danger badge rounded-pill p-1" style="font-size: 15px"
                                            data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2"
                                            aria-expanded="false" aria-controls="multiCollapseExample2">12</span>
