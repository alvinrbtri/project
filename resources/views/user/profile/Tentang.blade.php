    ...
    <section id="services" class="services section-bg " style="padding-top: 100px;">
        <div class="container px-3">
            <div style="width: 85%; margin-left:110px;">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"></i>TENTANG</h5>
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="desc mb-4" style="margin-left: 120px">
                                    <h6 class="text-center">
                                        <b>Layanan penitipan <span class="text-success"> PERTAMA </span> di Indonesia yang
                                            terdaftar dan telah dipercaya kredibilitasnya</b>
                                    </h6>
                                </div>
                                ...
                                <div class="pntp" style="margin-left: 150px">
                                    <h5 class="text-center text-success"><b>Kami tersedia di berbagai kota di Indonesia</b>
                                    </h5>
                                </div>
                            </div>
                        </div>
